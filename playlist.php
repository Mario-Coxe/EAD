...
<body>
            ...
            <div class="col">
               <form action="" method="post" class="save-list">
                  ...
                  if ($select_bookmark->rowCount() > 0) {
                     ...
                     ?>
                     <button type="submit" name="save_list"><i class="far fa-bookmark"></i><span>salvar
   ...
   <!-- section da playlist termina -->
   <!-- section de container de vídeos começa  -->
   ...
   <!-- section de container de vídeos termina -->
