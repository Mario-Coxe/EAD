      ...
      if ($select_playlist->rowCount() > 0) {
         while ($fetch_playlist = $select_playlist->fetch(PDO::FETCH_ASSOC)) {
            ...
            <form action="" method="post" enctype="multipart/form-data">
               ...
               <input type="text" name="title" maxlength="100" required placeholder="insira o título da playlist"
               ...
               <div class="flex-btn">
                  <input type="submit" value="excluir" class="delete-btn" onclick="return confirm('excluir esta playlist?');"
                     name="delete">
         ...
         echo '<p class="empty">ainda não foram adicionadas playlists!</p>';
      }
      ?>
   </section>
