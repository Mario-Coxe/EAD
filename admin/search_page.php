      ...
      <div class="box-container">
         ...
         if (isset($_POST['search']) or isset($_POST['search_btn'])) {
            ...
            if ($select_videos->rowCount() > 0) {
               ...
               echo '<p class="empty">nenhum conteúdo encontrado!</p>';
            }
         } else {
            echo '<p class="empty">por favor, pesquise algo!</p>';
         }
         ?>
               ...
               while ($fetch_playlist = $select_playlist->fetch(PDO::FETCH_ASSOC)) {
                  ...
                  <div class="box">
                     ...
                     <form action="" method="post" class="flex-btn">
                        ...
                        <input type="submit" value="excluir_playlist" class="delete-btn"
                           onclick="return confirm('excluir esta playlist?');" name="delete">
                     </form>
                     <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">visualizar playlist</a>
                  </div>
                  <?php
               }
            } else {
