...
<body>
   ...
   <!-- seção de seleção rápida começa  -->
      ...
      <div class="box-container">
         ...
         if ($user_id != '') {
            ...
            <div class="box">
               ...
               <p>playlists salvas: <span>
                     <?= $total_bookmarked; ?>
                  </span></p>
               <a href="bookmark.php" class="inline-btn">ver bookmarks</a>
            </div>
            <?php
         } else {
            ?>
            <div class="box" style="text-align: center;">
               <h3 class="title">faça login ou registre-se</h3>
         ...
         <div class="box">
            <h3 class="title">principais categorias</h3>
            <div class="flex">
               ...
               <a href="#"><i class="fas fa-vial"></i><span>ciência</span></a>
            </div>
         </div>
   ...
   <section class="courses">
      ...
      <div class="box-container">
         ...
         if ($select_courses->rowCount() > 0) {
            ...
            echo '<p class="empty">ainda não foram adicionados cursos!</p>';
         }
         ?>
      </div>
      <div class="more-btn">
