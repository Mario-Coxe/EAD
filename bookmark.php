...
<body>
   ...
   <section class="courses">
      <h1 class="heading">listas de reprodução favoritas</h1>
      <div class="box-container">
         ...
         if ($select_bookmark->rowCount() > 0) {
               ...
               if ($select_courses->rowCount() > 0) {
                  while ($fetch_course = $select_courses->fetch(PDO::FETCH_ASSOC)) {
                     ...
                     <div class="box">
                        ...
                        <a href="playlist.php?get_id=<?= $course_id; ?>" class="inline-btn">ver lista de reprodução</a>
                     </div>
                     <?php
                  }
               } else {
            ...
            echo '<p class="empty">ainda não foi marcado como favorito nada!</p>';
         }
         ?>
      </div>
   </section>
